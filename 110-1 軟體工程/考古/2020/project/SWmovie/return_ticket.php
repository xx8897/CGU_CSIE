...
<html>
	...
	<body background="./background.png">
		...
		<p class="area">
			...
			<a href="return_ticket.php" style="text-decoration: underline; ">退票</a>&nbsp &nbsp &nbsp &nbsp &nbsp
			<a href="history.php">紀錄查詢</a>
		</p>
		<br><br>
		<h1>訂票資訊</h1>
		
		<form name='Block' action="Refund.php" method="post">
					...
					<?php
						...
						if ($resultBook->num_rows > 0) 
						{
							while ($rowB = $resultBook->fetch_assoc())
							{
								...
								if(strtotime($TimeT) - strtotime($NowTimeA2) > 0)
									$Refund = true;
								...
								if($Refund)
								{
									...
									echo "<p style='color:#41464D;'>NO.$RecordID</p>";
									echo "<p class='Name'>$Name</p>";
									echo "<p><span class='Cinema'>第 $Cinema 廳&emsp;&emsp;</span>";
									echo "<span class='Time'>$TimeT &nbsp&nbsp $Num 張&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>&nbsp";
									echo "<input type='submit' name='$RecordID' class='return'  value='退票'></p>";
								}
