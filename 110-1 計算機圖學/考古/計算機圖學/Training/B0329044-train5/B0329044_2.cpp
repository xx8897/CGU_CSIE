...
void drow(void)
{
     ...
     set_center();
     GLfloat tx=-20,ty=50;             //translate
     for(int l=0; l<4; l++)            
     {
             square_2[l].x=square_1[l].x+tx;
             square_2[l].y=square_1[l].y+ty;
             square_1[l].x=square_2[l].x;
			 square_1[l].y=square_2[l].y;
     }
     
     set_center();
     GLfloat sx=2,sy=0.5;             //scale
     for(int j=0; j<4; j++)
     {
